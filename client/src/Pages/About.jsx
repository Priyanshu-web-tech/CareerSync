...
export default function Jobs() {
  ...
  return (
    <motion.div
      className="py-12 sm:py-20 px-6 sm:px-12 md:px-24 lg:px-32 xl:px-40  bg-gray-100"
    ...
    >
      <div className="max-w-4xl mx-auto">
        <motion.h1
          className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-center text-gray-800"
        ...
        <motion.div
          ...
          variants={textVariants}
        >
          <motion.div className="text-lg text-gray-700" variants={textVariants}>
            <p className="mb-8">
